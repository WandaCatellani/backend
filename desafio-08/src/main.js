...
app.get("/", (req, res) => {
  res.send(`<div style="background: rgb(233, 153, 206);"><h1 style="text-align: center;">Desafío 08 - Parte 01 - Express Avanzado</h1>
    <h2 style="text-align: center;">Wanda Catellani - Backend - Coderhouse</h2></div>
    <p>Consigna:</p>
...
app.get("/api/productos/:id", (req, res) => {
  const { id } = req.params;
  const products_filter = PRODUCTS_DB.find(
